...
class MoveGroupPythonIntefaceTutorial(object):
  ...
  def add_interferences(self, timeout=4):
    ...
    yBloc = [[-150, 150], [-990, 1150], [200, 1150], [-990, -200], [-990, 1150], [900, 1150], [-565, 780], [-565, 780], [-575, -565], [780,790], [-260, 460]]
    xBloc = [[-350, -200], [-1530, -860], [-1530, 860], [-1530, 860], [200, 860], [-270, -50], [910, 920], [-278, -268], [-268 ,910], [-268 ,910], [260, 860]]

    zBloc = [[-500, -150], [-500, 1530], [-500, -300], [-500, -300], [-500, -300], [-500, 1350], [-750, 2000],[-750, 2000], [-750, 2000], [-750, 2000], [-300, -290]]

    name = ["cables", "zone_travail", "plan_part1", "plan_part3", "plan_part2", "poteau", "box_x_pos", "box_x_neg", "box_y_neg", "box_y_pos", "working_area"]
    dilatation = 25 # mm
