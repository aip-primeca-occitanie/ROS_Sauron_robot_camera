...
class MoveGroupPythonIntefaceTutorial(object):
  ...
  def add_interferences(self, timeout=4):
    ...
    yBloc = [[-150, 150], [-990, 1150], [-990, 1150], [200, 1150], [-990, -200], [-990, 1150], [900, 1150], [1150, 1160], [-1000, -990], [-990, 1150]]
    xBloc = [[-350, -200], [-1530, -860], [-1530, -450], [-1530, 860], [-1530, 860], [200, 860], [-270, -50], [-1530, 860], [-1530, 860], [860, 870]]

    zBloc = [[-500, -150], [-500, 1530], [-500, 320], [-500, -300], [-500, -300], [-500, -300], [-500, 1350], [-500, 1530],[-500, 1530], [-500, 1530]]
